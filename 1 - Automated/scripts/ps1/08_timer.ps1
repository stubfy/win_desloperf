# 08_timer.ps1 - Install SetTimerResolution to AppData and add to Windows startup
#
# Background:
...
#
# Rollback: restore\05_timer.ps1 deletes the startup shortcut and terminates the process.
