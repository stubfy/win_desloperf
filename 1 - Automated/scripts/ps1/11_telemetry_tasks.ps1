# 11_telemetry_tasks.ps1 - Disable telemetry scheduled tasks + PS7 telemetry + Brave
#
...
if ($braveInstalled) {
    ...
    # Disable automatic Brave update checks (same pattern as Chromium auto-update policies).
