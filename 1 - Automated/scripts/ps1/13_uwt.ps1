# 13_uwt.ps1 - Registry tweaks equivalent to Ultimate Windows Tweaker 5 (settings_v2.ini)
# Covers: privacy, context menu cleanup, security/UI defaults, visual effects preset
# Purely subjective shell/theme preferences live in 14_personal_settings.ps1.
