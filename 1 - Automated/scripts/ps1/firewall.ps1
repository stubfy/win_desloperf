# firewall.ps1 - Disable Windows Firewall profiles
#
...
# backup\firewall_state.json by backup.ps1 for precise rollback.
#
# Rollback: 1 - Automated\\restore\\firewall.bat reads firewall_state.json and restores
