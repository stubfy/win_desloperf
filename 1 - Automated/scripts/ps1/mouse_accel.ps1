# mouse_accel.ps1 - MarkC mouse acceleration fix (1:1 scaling, auto-detect DPI)
...
#
# Note: tweaks_consolidated.reg (imported by registry.ps1) contains the 100%
...
#
# Rollback: restore\mouse_accel.ps1 imports the Windows default curves.
