# uwt.ps1 - Registry tweaks equivalent to Ultimate Windows Tweaker 5 (settings_v2.ini)
# Covers: privacy, context menu cleanup, security/UI defaults, visual effects preset
# Purely subjective shell/theme preferences live in personal_settings.ps1.
...
# Windows Security Center (wscsvc) is not in services.ps1 because it is a
